package com.church.simgokchyun.common.paging;
...
public class Pagination {
	...
	public Pagination(int totalListCnt, int page) {
		...
		/** 13. 마지막 블럭(클릭 시, 마지막 블럭 첫번째 페이지) **/
		setLastBlock(((totalBlockCnt-1) * blockSize) +1 );


		/** 14. 마지막 블럭 보이는 숫자 */
		setLastBlockShowNo(totalBlockCnt - block);
