...
public class sgc_007Controller {
    ...
    String sgc_007_01_DETAIL_S(Board board, Model model, @AuthenticationPrincipal OAuth2User oauth, HttpServletRequest request) {
    ...
    String sgc_007_02_DETAIL_S(Board board, Model model, @AuthenticationPrincipal OAuth2User oauth, HttpServletRequest request) {
